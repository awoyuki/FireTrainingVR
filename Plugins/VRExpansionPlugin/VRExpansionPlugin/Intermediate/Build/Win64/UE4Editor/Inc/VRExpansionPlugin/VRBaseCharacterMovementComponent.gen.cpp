...
// End Cross Module References
	...
	DEFINE_FUNCTION(UVRBaseCharacterMovementComponent::execPerformMoveAction_SetRotationTwoPointVector)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->PerformMoveAction_SetRotationTwoPointVector(Z_Param_Rotation,Z_Param_NewYaw,EVRMoveActionVelocityRetention(Z_Param_VelocityRetention),Z_Param_bFlagGripTeleport,Z_Param_bFlagCharacterTeleport);
		P_NATIVE_END;
	}
	...
	void UVRBaseCharacterMovementComponent::StaticRegisterNativesUVRBaseCharacterMovementComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "PerformMoveAction_SetRotationTwoPointVector", &UVRBaseCharacterMovementComponent::execPerformMoveAction_SetRotationTwoPointVector },
	...
	struct Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics
	{
		struct VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms
		{
			FRotator Rotation;
			float NewYaw;
			EVRMoveActionVelocityRetention VelocityRetention;
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_NewYaw = { "NewYaw", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms, NewYaw), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_VelocityRetention_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_VelocityRetention = { "VelocityRetention", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms, VelocityRetention), Z_Construct_UEnum_VRExpansionPlugin_EVRMoveActionVelocityRetention, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_bFlagGripTeleport_SetBit(void* Obj)
	{
		((VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms*)Obj)->bFlagGripTeleport = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_bFlagGripTeleport = { "bFlagGripTeleport", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms), &Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_bFlagGripTeleport_SetBit, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_bFlagCharacterTeleport_SetBit(void* Obj)
	{
		((VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms*)Obj)->bFlagCharacterTeleport = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_bFlagCharacterTeleport = { "bFlagCharacterTeleport", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms), &Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_bFlagCharacterTeleport_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_Rotation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_NewYaw,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_VelocityRetention_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_VelocityRetention,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_bFlagGripTeleport,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::NewProp_bFlagCharacterTeleport,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::Function_MetaDataParams[] = {
		{ "Category", "VRMovement" },
		{ "Comment", "// This node specifically sets the FACING direction to a value, where your two point\n" },
		{ "CPP_Default_bFlagCharacterTeleport", "false" },
		{ "CPP_Default_bFlagGripTeleport", "false" },
		{ "CPP_Default_VelocityRetention", "VRMOVEACTION_Velocity_None" },
		{ "ModuleRelativePath", "Public/VRBaseCharacterMovementComponent.h" },
		{ "ToolTip", "This node specifically sets the FACING direction to a value, where your two point" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVRBaseCharacterMovementComponent, nullptr, "PerformMoveAction_SetRotationTwoPointVector", nullptr, nullptr, sizeof(VRBaseCharacterMovementComponent_eventPerformMoveAction_SetRotationTwoPointVector_Parms), Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVRBaseCharacterMovementComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UVRBaseCharacterMovementComponent_PerformMoveAction_SetRotationTwoPointVector, "PerformMoveAction_SetRotationTwoPointVector" }, // 3525380475
	...
	IMPLEMENT_CLASS(UVRBaseCharacterMovementComponent, 1687953547);
